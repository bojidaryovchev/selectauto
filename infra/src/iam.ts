 ...
 * @param queueArns ARNs of SQS queues the Lambdas CONSUME (the detail-refresh worker).
 */
export function createLambdaRole(
  ...
  // SQS consume permissions for the drain worker (the event source mapping needs
  // these to receive/delete messages and read attributes).
