        ...
        const carRes = await client.query<{ id: number }>(
          `INSERT INTO cars
             (external_car_id, vin, title, year, manufacturer_id, model_id, generation_id,
              body_type, color, fuel_type, transmission, drive_wheel, engine, raw_json, updated_at)
        ...
        await client.query(
          `INSERT INTO auction_lots
             (external_lot_id, car_id, lot_number, domain_id, domain_name, status, sale_date,
              ...
              seller, location_country, location_state, location_city, image_url, raw_json, updated_at)
