      ...
      <main className="flex-1 bg-[#fafafa] pt-(--header-h) text-ink">
        <Container>
          <div className="py-10 max-md:py-7">
            <div className="mb-6 h-10 w-72 animate-pulse rounded-sm bg-[#e9e9ea]" />
            <div className="h-65 animate-pulse rounded-2xl border border-line bg-white" />
            <div className="mb-4 mt-6 h-4 w-44 animate-pulse rounded-sm bg-[#e9e9ea]" />
