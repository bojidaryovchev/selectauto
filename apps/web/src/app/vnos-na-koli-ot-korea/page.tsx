        ...
        <Container className="max-w-245 py-12 max-md:py-8">
          ...
          <section className="mb-12">
            ...
            <p className="mb-5 max-w-2xl text-sm/relaxed text-[#3d4046]">
              Изчисли ориентировъчна разбивка на разходите за внос от Корея — комисионна, транспорт, мито (0% или
              10%), ДДС и по желание технотест. Всички суми са в долари ($). Ставките са проверени към{" "}
              {RATES_VERIFIED_AT}. За обвързваща оферта за конкретен автомобил направи запитване.
            </p>
