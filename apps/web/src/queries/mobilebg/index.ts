export { getCarGallery, type CarGallery } from "./get-car-gallery.query";
export { getMobilebgCarSource, type MobilebgSourceResult } from "./get-advert-source.query";
export { getMobilebgPreview, type MobilebgPreview } from "./get-advert-preview.query";
