...
export function AboutIntro() {
  return (
    <section className="bg-[linear-gradient(180deg,#f7f7f8_0%,#f1f2f5_100%)] py-22 max-md:py-14.5">
      <Container>
        <SectionHeader
          eyebrow="Кои сме ние"
          ...
          className="mb-11 max-w-230"
        />

        <Reveal delay={0.08}>
          <p className="mx-auto max-w-245 text-center text-xl font-medium leading-[1.95] text-[#3d4046] max-md:text-base">
