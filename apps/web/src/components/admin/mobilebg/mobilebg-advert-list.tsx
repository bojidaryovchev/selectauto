  ...
  return (
    <div className="space-y-3">
      ...
      <ConfirmDialog
        ...
        message={
          <>
            Обявата ще бъде премахната от mobile.bg (ID {target?.ida}). Изтриването е безплатно
            и спира седмичната такса; вече платени VIP/ТОП услуги не се възстановяват (Общи
            условия, т. I.15, I.16, II.8).
          </>
        }
      />
    </div>
